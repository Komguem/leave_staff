<div class="left-side-bar">
		<div class="brand-logo">
			<a href="admin_dashboard.php">
				<img src="../vendors/images/Image3.png" alt="" class="dark-logo">
				...
				<ul id="accordion-menu">
					...
					<li>
						<a href="department.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Département</span>
						</a>
					</li>
					<li>
						<a href="leave_type.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Type de congé</span>
						</a>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext">Employé</span>
						</a>
						<ul class="submenu">
							<li><a href="add_staff.php">Nouveau employé</a></li>
							<li><a href="staff.php">Gestion des employés</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						...
						<ul class="submenu">
							...
							<li><a href="rejected_leave.php">Refusé</a></li>
						</ul>
					</li>
					...
					<li>
						<a href="https://s2bi.africa/" class="dropdown-toggle no-arrow">
