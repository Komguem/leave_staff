			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Avis DRH </b></label>
								<div class="col-sm-12 col-md-10">
									<?php
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
								   <label style="font-size:16px;"><b>Action</b></label>
								   <?php
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Décision</b></label>
